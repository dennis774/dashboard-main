...
{
    public function chart_expenses_index(Request $request)
    {
        ...
        $actionRoute = route('pages.Expenses.index'); // Dynamically set this based on your logic      
        $totalExpenses = $chartdata->sum('expenses');
        return view('pages.Expenses.index', compact('chartdata', 'totalExpenses', 'actionRoute'));
